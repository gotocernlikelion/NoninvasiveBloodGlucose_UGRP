...
%%
    ...
    for i = 1:hgt
        ...
        if gc.Model(i)=="a2A2840-67g5m"     
            g(i).AcquisitionFrameRate = B.FPS;
            g(i).AcquisitionFrameRateEnable = 'True';
            g(i).Width = 128;      g(i).Height = 128;
            g(i).OffsetY = 1252;    g(i).OffsetX = 1376;    g(i).Gain = 3;
            g(i).ExposureTime = B.Exposure_time;
        else
            g(i).AcquisitionFrameRateAbs = B.FPS;
            g(i).AcquisitionFrameRateEnable = 'True';
            g(i).Width = 128;      g(i).Height = 128;
            g(i).OffsetY = 427;    g(i).OffsetX = 555;    g(i).GainRaw = 3;
...
%%
   ...
   for j = 1:totalframe
       ...
       for i = 1 : hgt
           %waitbar(j/totalframe, f,'Measuring');
           CH(i).test_img = snapshot(g(i));
